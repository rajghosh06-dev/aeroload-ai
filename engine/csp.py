...
class AeroLoadCSP:
    ...
    def get_bay(
        ...
        return self.aircraft.require_bay(bay_id)
    ...
    def is_consistent(
        ...
        # Constraint 3:
        # Hazard-incompatible cargo cannot occupy adjacent bays.
        for other_cargo_id, other_bay_id in assignment.items():
